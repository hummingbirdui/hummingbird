...
A list of all available utility classes for the navs & tabs component.
...
<Example showPreview={false} lang='sass' code={`.nav {
    ...
    --nav-link-disabled-color: var(--text-color-subtle);
