...
async function loadStylesheet(id: string, base: string) {
  ...
  const stylesheetConfigs = [
    ...
    {
      ids: ['./close.css'],
      path: 'virtual:hummingbirdui/close.css',
      content: () => assets.css.hbClose,
    },
    {
    ...
    {
      ids: ['./plugins.css'],
      path: 'virtual:hummingbirdui/plugins.css',
      content: () => assets.css.hbPlugins,
    },
    {
      ids: ['./choices.css'],
      path: 'virtual:hummingbirdui/choices.css',
      content: () => assets.css.hbChoices,
    },
    {
      ids: ['./dropzone.css'],
      path: 'virtual:hummingbirdui/dropzone.css',
      content: () => assets.css.hbDropzone,
    },
    {
      ids: ['./flatpickr.css'],
      path: 'virtual:hummingbirdui/flatpickr.css',
      content: () => assets.css.hbFlatpickr,
    },
    {
      ids: ['./nouislider.css'],
      path: 'virtual:hummingbirdui/nouislider.css',
      content: () => assets.css.hbNoUiSlider,
    },
  ];
