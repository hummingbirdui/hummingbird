---
title: Gatsby
description:  This guide explains how to set up Hummingbird with Gatsby using Tailwind CSS. It covers project setup, configuration, and usage for quickly building and styling components in a Gatsby app.
redirects: true
---
...
Follow the <a href="https://tailwindcss.com/docs/installation/framework-guides/gatsby" target="_blank" rel="noopener noreferrer">official installation guide</a> to install Tailwind CSS in a Gatsby project.
