...
<Example class="flex flex-wrap gap-2 justify-center" 
  ...
  <button class='btn btn-subtle-light'>Light</button>
  <button class='btn btn-subtle-dark'>Dark</button>`} 
/>
...
Icon buttons display only an icon and are often used in app bars and toolbars. By default icon buttons are square, Use border radius classes to create custom shapes or use the `btn-circle` class for circular button.
...
<Example class="flex flex-wrap gap-2 justify-center items-center" 
  ...
  <button class='btn btn-icon btn-icon-danger rounded-full'>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 0 0 0 6.364L12 20.364l7.682-7.682a4.5 4.5 0 0 0-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 0 0-6.364 0"/>
    </svg>
  </button>
...
Use the `w-full` utility to create a block button that spans the full width of its parent container.

<Example class='space-y-2'
  code={`<button class='btn btn-primary w-full'>Block button</button>
...
<Example
  ...
  code={`<button class="btn bg-linear-to-r from-cyan-400 to-blue-500 text-white border-0">
    Primary
  </button>
  <button class="btn bg-linear-to-br from-purple-400 to-blue-500 text-white border-0">
    Secondary
  </button>
  <button class="btn bg-linear-to-r from-cyan-400 to-sky-500 text-white border-0">
    Info
  </button>
  <button class="btn bg-linear-to-br from-green-400 to-blue-500 text-white border-0">
    Success
  </button>
  <button class="btn bg-linear-to-br from-orange-400 to-rose-500 text-white border-0">
    Warning
  </button>
  <button class="btn bg-linear-to-br from-pink-400 to-red-500 text-white border-0">
    Danger
  </button>
  <button class="btn bg-linear-to-r from-slate-200 to-gray-300 text-slate-800 border-0">
    Neutral
  </button>`}
/>
...
<Example class="flex flex-wrap gap-2 justify-center"
  code={`<button class='btn btn-primary shadow-sm shadow-primary/30'>Primary</button>
...
<Example class="flex flex-wrap gap-2 justify-center"
  code={`<button class='btn btn-primary opacity-100'>Opacity-100</button>
...
Apply the `disabled` attribute on `<button>` elements to disable the button.

<Example class="flex flex-wrap gap-2 justify-center" 
  code={`<button class='btn' disabled>Button</button>
...
<Example class="flex flex-wrap gap-2 justify-center" 
  code={`<a class='btn disabled' role="button" aria-disabled="true">Link</a>
...
The button component is built using a set of CSS variables. These variables provide flexibility for customizing styles globally or locally. Read more about customizing with CSS variables [here](/docs/customize/component#using-css-variables).
...
<Example lang='sass' showPreview={false}
  code={`@theme {
    ...
    --input-btn-padding-x-sm: --spacing(3);
    --input-btn-padding-y-sm: --spacing(1.25);
    --input-btn-border-radius-sm: var(--radius-sm);
    --input-btn-line-height-sm: 1.25;

    --input-btn-font-size-lg: var(--text-base);
    --input-btn-padding-x-lg: --spacing(5);
    --input-btn-padding-y-lg: --spacing(2.25);
