...
<Example lang="js" showPreview={false} code={`const previewsContainer = document.querySelector('[data-dz-preview="dz-list-preview"]');
...
<Example lang="js" showPreview={false} code={`const previewsContainer = document.querySelector('[data-dz-preview="dz-thumbnail-preview"]');
  const previewTemplate = previewsContainer.querySelector('.dz-preview-template');
...
<Example lang="js" showPreview={false} code={`const previewsContainer = document.querySelector('[data-dz-preview="dz-dropbox-preview"]');
  const previewTemplate = previewsContainer.querySelector('.dz-preview-template');
...
<Example lang="js" showPreview={false} code={`const previewsContainer = document.querySelector('[data-dz-preview="dz-single-preview"]');
  const previewTemplate = previewsContainer.querySelector('.dz-preview-template');
