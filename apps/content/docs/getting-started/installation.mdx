...
Hummingbird is a fast, lightweight UI framework built on top of Tailwind CSS utility classes. Write cleaner HTML, customize with utilities, and bring a project to life with interactive, accessible components. Start building today by following the quickstart guide.

## Quick Setup (CLI)

The fastest way to scaffold a full Hummingbird project is using `create-hummingbird-app` which sets up the project structure and configuration files for you. To create a new project run:
