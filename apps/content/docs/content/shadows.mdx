...
<Example class="flex flex-wrap items-center justify-center gap-5 mx-auto max-w-xl bg-white! rounded-b-none [&_div]:size-32 [&_div]:flex [&_div]:items-center [&_div]:justify-center [&_div]:rounded-xl" code={`<div class="shadow-sm shadow-primary-light/50 bg-primary-lighter"></div>
...
<Example class="flex flex-wrap items-center justify-center gap-5 mx-auto max-w-xl bg-white! rounded-b-none [&_div]:size-32 [&_div]:flex [&_div]:items-center [&_div]:justify-center [&_div]:rounded-xl [&_div]:transition" code={`<div class="hover:shadow-sm hover:shadow-primary-light/50 bg-primary-lighter"></div>
...
<Example class="flex flex-wrap items-center justify-center gap-5 mx-auto max-w-xl bg-white! rounded-b-none [&_div]:size-32 [&_div]:flex [&_div]:items-center [&_div]:justify-center [&_div]:rounded-xl" code={`<div class="inset-shadow-sm inset-shadow-primary-light/50 bg-primary-lighter"></div>
...
<Example class="flex flex-wrap items-center justify-center gap-5 mx-auto max-w-xl bg-white! rounded-b-none [&_div]:size-32 [&_div]:flex [&_div]:items-center [&_div]:justify-center [&_div]:rounded-xl" code={`<div class="ring-2 ring-primary-light/50 bg-primary-lighter"></div>
