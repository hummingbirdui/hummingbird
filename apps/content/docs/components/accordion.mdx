...
toc: true
attributeComponent: Accordion
attributeLink: https://getbootstrap.com/docs/5.3/components/accordion/
classNames:
  component:
    - class: accordion
      desc: Accordion
...
## How it works
The accordion internally utilizes the [collapse](https://hbui.dev/docs/components/collapse/) component for its collapsible functionality.
...
<div class="alert alert-subtle-info items-start mb-6" role="alert">
  ...
  <span class="-mt-1">The animation effect of this component relies on the `prefers-reduced-motion` media query. Refer to the <a href="https://getbootstrap.com/docs/5.3/getting-started/accessibility/#reduced-motion" target="_blank">accessibility documentation's</a> reduced motion section for details.</span>
</div>
...
<div class="alert alert-subtle-danger items-start mb-6" role="alert">
  <svg class='alert-icon' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M12 17q.425 0 .713-.288T13 16t-.288-.712T12 15t-.712.288T11 16t.288.713T12 17m0-4q.425 0 .713-.288T13 12V8q0-.425-.288-.712T12 7t-.712.288T11 8v4q0 .425.288.713T12 13m0 9q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22m0-2q3.35 0 5.675-2.325T20 12t-2.325-5.675T12 4T6.325 6.325T4 12t2.325 5.675T12 20m0-8" stroke-width="0.5" stroke="currentColor"/></svg>
  <span class="-mt-1">**All API methods are asynchronous and initiate a transition.** They return to the caller immediately after the transition begins, but before it concludes. Additionally, a method call on a component that is already transitioning will be disregarded. More information is available in Bootstrap's
