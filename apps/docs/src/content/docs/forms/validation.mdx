...
The validation styles make use of CSS variables for easy customization. Read more about customizing with CSS variables [here](/docs/customize/component#using-css-variables).
...
<Example lang="sass" showPreview={false}
  code={`@theme {
    ...
    --form-feedback-tooltip-color: var(--color-inverse);
