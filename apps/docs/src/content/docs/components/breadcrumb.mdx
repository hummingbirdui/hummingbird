...
<Example code={`<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href='#' class="badge badge-subtle-neutral badge-link">Home</a></li>
      <li class="breadcrumb-item"><a href='#' class="badge badge-subtle-neutral badge-link">Component</a></li>
      <li class="breadcrumb-item active" aria-current="page"><span class="badge badge-subtle-neutral">Breadcrumb</span></li>
    </ol>
  </nav>`} />

## Class Overview

A list of all available utility classes for the breadcrumb component.
...
The breadcrumb component is built using a set of CSS variables. These variables provide flexibility for customizing styles. Read more about customizing with CSS variables [here](/docs/customize/component#using-css-variables).
