---
title: Astro
description: This guide explains how to set up Hummingbird with Astro using Tailwind CSS. It covers project setup, configuration, and usage for quickly building and styling components in a Astro app.
redirects: true
---
...
Follow the <a href="https://tailwindcss.com/docs/installation/framework-guides/astro" target="_blank" rel="noopener noreferrer">official installation guide</a> to install Tailwind CSS in an Astro project.
