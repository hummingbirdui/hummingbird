...
toc: true
attributeComponent: Offcanvas
attributeLink: https://getbootstrap.com/docs/5.3/components/offcanvas/
classNames:
  component:
    - class: offcanvas
      desc: Offcanvas container
    - class: offcanvas-sm
      desc: Make offcanvas under sm breakpoint
    - class: offcanvas-md
      desc: Make offcanvas under md breakpoint
    - class: offcanvas-lg
      desc: Make offcanvas under lg breakpoint
    - class: offcanvas-xl
      desc: Make offcanvas under xl breakpoint
    - class: offcanvas-xxl
      desc: Make offcanvas under 2xl breakpoint
  modifier:
...
- Correspondingly, some [css variables](#css-variables) governing offcanvas styles and dimensions are inherited from modal variables.
...
A list of all available utility classes for the offcanvas component.
...
The offcanvas component is built using a set of CSS variables. These variables provide flexibility for customizing styles. Read more about customizing with CSS variables [here](/docs/customize/component#using-css-variables).
