...
<Example>
  <div slot="preview" class="space-y-3">
    <div class="input-group">
      <button class="btn btn-outline-neutral" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown<span class="icon-[iconamoon--arrow-down-2-fill] text-base"></span></button>
