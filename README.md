...
```html
<script src="https://cdn.jsdelivr.net/npm/@hummingbirdui/browser@1.2.1/dist/index.global.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@hummingbirdui/hummingbird@1.2.1/dist/hummingbird.bundle.min.js"></script>
```
