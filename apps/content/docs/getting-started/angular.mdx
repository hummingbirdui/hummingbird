---
title: Angular
description: This guide explains how to set up Hummingbird with Angular and Angular SSR using Tailwind CSS. It covers project setup, configuration, and usage so you can quickly build and style components in your Angular app.
toc: true
---

## Install Tailwind CSS

Follow the <a href="https://tailwindcss.com/docs/installation/framework-guides/angular" target="_blank" rel="noopener noreferrer">official installation guide</a> to install Tailwind CSS in your Angular project.
...
Import Hummingbird inside the ngOnInit lifecycle hook of your root component. This ensures Hummingbird is loaded when the component initializes.
...
Inject this service into your root or feature components to safely load Hummingbird only in the browser.
