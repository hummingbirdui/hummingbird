...
<Example class='text-center' code={`<div class="avatar">
    <img src="${getVersionedPath('/images/avatar_1.webp')}" alt="Avatar" class="rounded-full" />
  </div>`}
/>
...
<Example class='flex items-center justify-center gap-2' code={`<div class="avatar avatar-xs">
  ...
  <div class="avatar avatar-sm">
    <img src="${getVersionedPath("/images/avatar_2.webp")}" alt="Avatar" class="rounded-full" />
  </div>
  <div class="avatar">
    <img src="${getVersionedPath("/images/avatar_3.webp")}" alt="Avatar" class="rounded-full" />
  </div>
  <div class="avatar avatar-lg">
    <img src="${getVersionedPath("/images/avatar_4.webp")}" alt="Avatar" class="rounded-full" />
  </div>`} />
...
<Example class='flex flex-col items-center gap-2' code={`<div class="flex gap-2">
    ...
    <div class="avatar">
      <img src="${getVersionedPath("/images/avatar_1.webp")}" alt="Avatar" class="rounded" />
    </div>
    <div class="avatar">
      <img src="${getVersionedPath("/images/avatar_1.webp")}" alt="Avatar" />
    </div>
  </div>
...
<Example class='flex justify-center' code={`<div class="avatar-group">
    ...
    <div class="avatar">
      <img src="${getVersionedPath("/images/avatar_2.webp")}" alt="Avatar" />
    </div>
    <div class="avatar">
      <img src="${getVersionedPath("/images/avatar_3.webp")}" alt="Avatar" />
    </div>
    <div class="avatar">
      <img src="${getVersionedPath("/images/avatar_4.webp")}" alt="Avatar" />
    </div>
    <div class="avatar">
