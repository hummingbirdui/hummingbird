...
<Example>
  <div slot="preview" class="not-prose grid items-center gap-3 sm:grid-cols-2">
    <div class="form-floating form-field">
      <textarea type="text" class="form-control-fill" id="floatingTextarea" placeholder=" " />
      <label class="form-label" for="floatingTextarea">
        Message
      </label>
    </div>
    <div class="form-floating form-field">
      <textarea type="text" class="form-control" id="floatingTextareaOutline" placeholder=" " />
