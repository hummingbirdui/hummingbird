...
classNames:
  ...
  - class: badge-lg
    desc: Large size
  style:
  - class: badge-subtle-{color}
    desc: Subtle style
  - class: badge-outline-{color}
    desc: Outline style
  modifier:
  - class: badge-link
...
<Example class='flex justify-center gap-2' code={`<span class="badge badge-neutral">Neutral</span>
  <span class="badge badge-subtle-neutral">Neutral</span>
...
The badge component is built using a set of CSS variables. These variables provide flexibility for customizing styles. Read more about customizing with CSS variables [here](/docs/customize/component#using-css-variables).
...
<Example lang='sass' showPreview={false}
  code={`.badge {
    ...
    --badge-link-hover-bg: var(--color-neutral);
