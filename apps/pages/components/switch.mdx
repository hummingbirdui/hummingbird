---
title: Switch
desc: Switches toggle the state of a single setting on or off.
...
<Example>
  <div slot='preview' class="flex gap-2">
    ...
    <div for="switchError" class="form-switch">
      <input class="form-check-input form-check-error" type="checkbox" value="" id="switchError" checked />
    </div>
