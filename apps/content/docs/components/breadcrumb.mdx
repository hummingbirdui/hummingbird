...
Create breadcrumbs with a semantic list (`ol` or `ul`) of linked items. Style spacing, color, and separators with utility classes to match your design.
...
<Example lang='sass' showPreview={false}
  code={`--breadcrumb-font-size: var(--text-sm);
