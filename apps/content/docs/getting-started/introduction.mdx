...
Alternatively, Hummingbird can be imported in the JavaScript entry file.
...
Hummingbird also provides a JavaScript API for programmatic control of components. For example, an modal can be toggled manually using the API.
