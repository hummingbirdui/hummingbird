...
<Example>
  ...
  <div slot="code">
    ...
    <label for="checkChecked" class="form-check-input-wrapper">
      <input class="form-check-input" type="checkbox" value="" id="checkChecked" checked />
    </label>
    <label for="checkDisabled" class="form-check-input-wrapper">
...
<Example>
  ...
  <div slot="code">
    ...
    <div class="form-check">
      ...
      <label for="checkboxDefaultLabel" class="form-check-label">
        Basic Checkbox
      </label>
    </div>
    <div class="form-check">
      ...
      <label for="checkboxCheckedLabel" class="form-check-label">
        Checked
      </label>
    </div>
    <div class="form-check">
      ...
      <label for="checkboxDisabledLabel" class="form-check-label">
        Disabled
      </label>
    </div>
    ```
...
<Example>
  ...
  <div slot="code">
    ...
    <div class="form-check-inline">
      ...
      <label for="checkboxInline" class="form-check-label">
        Inline Checkbox
      </label>
    </div>
    <div class="form-check-inline">
      ...
      <label for="inlineChecked" class="form-check-label">
        Checked
      </label>
    </div>
    <div class="form-check-inline">
      ...
      <label for="inlineDisabled" class="form-check-label">
        Disabled
      </label>
    </div>
    ```
