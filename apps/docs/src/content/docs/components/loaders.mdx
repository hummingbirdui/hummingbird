...
<Example class='flex flex-wrap gap-2'
  ...
  <div class="spinner-border text-neutral" role="status">
    <span class="sr-only">Loading...</span>
  </div>`}
/>
...
<Example class='flex flex-wrap gap-2' code={`<div class="spinner-grow text-primary" role="status">
  ...
  <div class="spinner-grow text-neutral" role="status">
    <span class="sr-only">Loading...</span>
  </div>`}
/>
...
The Loader component is built using a set of CSS variables. These variables provide flexibility for customizing styles. Read more about customizing with CSS variables [here](/docs/customize/component#using-css-variables).
