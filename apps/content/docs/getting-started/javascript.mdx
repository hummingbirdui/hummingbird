...
Hummingbird can be integrated into various JavaScript frameworks, including [React](/docs/getting-started/framework-guides/react), [Vue](/docs/getting-started/framework-guides/vue), [Angular](/docs/getting-started/framework-guides/angular), and more. Leverage its components within these frameworks by following best practices for DOM manipulation and component lifecycle management.
...
Some JavaScript components rely on [Popper](https://popper.js.org/docs/v2/) for positioning elements, such as dropdowns, tooltips, and popovers. When using these components, include `Popper.js` in the project, or use `hummingbird.bundle.min.js`, which includes `Popper.js`.
