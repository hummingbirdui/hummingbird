...
description: Hummingbird components can be customized using theme variables, utility classes, or custom CSS to match specific design needs.
toc: true
---
...
<h4 class='font-medium'>Option 3: <code class='text-base'>@apply</code> directive</h4>
