...
<Example class="max-w-145 mx-auto" code={`<ul class="list-group flex-row overflow-x-auto">
    <li class="list-group-item" aria-current="true">
      ...
      <p class="mb-0 text-sm text-center">Carter</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_2.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Fiona</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_3.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Marcus</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_4.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Emma</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_5.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Taylor</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_6.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Xavier</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_7.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Isabella</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_8.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Maya</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_9.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Isaac</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_10.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Olivia</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_11.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Lily</p>
    </li>
    <li class="list-group-item">
      <div class="avatar avatar-lg">
        <img src="/images/avatar_12.webp" alt="Avatar" class="rounded-full" />
      </div>
      <p class="mb-0 text-sm text-center">Quinn</p>
    </li>
  </ul>`} 
/>
