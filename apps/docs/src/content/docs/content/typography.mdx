...
<Example class="space-y-5 max-w-90 mx-auto overflow-hidden" code={`<p class="text-wrap border border-danger/40"><strong>text-wrap</strong> - This text wraps onto the next line when it reaches the container width.</p>
