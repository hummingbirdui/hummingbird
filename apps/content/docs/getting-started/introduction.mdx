...
**Optimization:**  To reduce the final bundle size, only the specific JavaScript plugins needed can be imported. Follow the [optimization](/docs/getting-started/javascript#optimization) approach in the JavaScript section.
