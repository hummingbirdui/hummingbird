    ...
    <ul class="list-group">
      <li class="list-group-item flex items-start gap-3">
        ...
        <div>
          ...
          <p>Great breakdown of the new JavaScript features! I especially appreciated the examples on optional chaining. One suggestion—maybe include performance benchmarks for real-world cases?</p>
      ...
      <li class="list-group-item flex items-start gap-3">
        ...
        <div>
          ...
          <p>This place looks amazing! The colors in your photo are stunning. Where exactly is this? I’d love to visit someday!</p>
          <div class="mt-3 space-x-2">
      ...
      <li class="list-group-item flex items-start gap-3">
        ...
        <div>
          ...
          <p>Super helpful tutorial—thank you! You explained the steps clearly and kept it beginner-friendly. Could you do a follow-up on more advanced techniques?</p>
          <div class="mt-3 space-x-2">
