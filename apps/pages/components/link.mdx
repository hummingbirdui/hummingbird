---
title: Link
desc: Link utilities are used to stylize your anchors to adjust their color, opacity, underline offset, underline color, and more.
...
<Example>
  <div slot="preview" class='space-x-3 space-y-2'>
    ...
    <a href="#!" class="link link-hover link-error">Error</a>
