...
classNames:
  component:
  - class: hr-label
    desc: Horizontal divider with label
  - class: vr-label
    desc: Vertical divider with label
  modifier:
  - class: label-start
    desc: Align label start
  - class: label-end
    desc: Align label end
---
...
A list of all available utility classes for the divider component.
