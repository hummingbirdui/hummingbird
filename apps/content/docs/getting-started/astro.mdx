...
##### Optimization
**Optional:** you can optimize your application by only importing the components you need in your main layout file. The below example demonstrates how to import only the `modal` script.
