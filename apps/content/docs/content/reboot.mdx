...
For all paragraph (`<p>`) elements removed `margin-top` and set `margin-bottom: 1rem`.
...
The following CSS variables are defined in Hummingbird's for reboot styles. Override these variables in the CSS to customize the base styles of the project.
