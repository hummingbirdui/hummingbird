...
import hbDefaultTheme from '@hummingbirdui/hummingbird/src/themes/default.css';
import hbDefaultPalette from '@hummingbirdui/hummingbird/src/palettes/default.css';
