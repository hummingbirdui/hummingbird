  ...
  <div data-dz-preview="dz-list-preview" class="dz-list-preview">
    <div class="dz-preview-template hidden">
      <div  class="dz-preview dz-file-preview">
        <div class="dz-image">
          <img src="${getVersionedPath('/images/file-icon.svg')}" data-dz-thumbnail />
        </div>
...
A list of all available utility classes for the file uploader component.
...
<Example showPreview={false} lang='sass' code={`.dropzone {
    ...
    --uploader-avatar-overlay: --alpha(var(--color-inverse) / 70%);
    ...
    --uploader-mark-bg: --alpha(var(--color-neutral) / 80%);
    ...
    --uploader-progress-mark-border-color: --alpha(var(--color-neutral) / 80%);
    --uploader-progress-mark-border-radius: var(--radius-xl);
    --uploader-progress-mark-bg: --alpha(var(--color-neutral) / 80%);
  ...
  .dz-thumbnail-preview {
    ...
    --uploader-thumbnail-remove-btn-bg: var(--color-neutral);
