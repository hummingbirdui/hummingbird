...
export const tabsData: TabData[] = [
  ...
  <div class="flex items-center gap-1">
    <button class="btn btn-square h-7.5 w-7.5 text-emphasis bg-highlight rounded-sm"><RemoveIcon /></button>
    <span class="px-5 py-1.25 text-subtle text-sm bg-muted rounded-sm">2</span>
    <button class="btn btn-square h-7.5 w-7.5 bg-muted rounded-sm"><AddIcon /></button>
  </div>
