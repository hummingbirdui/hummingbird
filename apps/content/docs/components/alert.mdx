...
Outlined alerts utilize a border and transparent background for medium emphasis. They are useful when feedback messages need to be visible without dominating the interface.
