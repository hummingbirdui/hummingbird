...
<Example>
  <div slot="preview" class="not-prose">
    <div class="form-check">
      ...
      <label for="radioDefaultLabel" class="form-check-label">
        Basic Checkbox
      </label>
    </div>
    <div class="form-check">
      ...
      <label for="radioCheckedLabel" class="form-check-label">
        Checked
      </label>
    </div>
    <div class="form-check">
      ...
      <label for="radioDisabledLabel" class="form-check-label">
        Disabled
      </label>
    </div>
  </div>
...
<Example>
  <div slot="preview" class="not-prose">
    <div class="form-check-inline">
      ...
      <label for="radioInline" class="form-check-label">
        Inline Radio
      </label>
    </div>
    <div class="form-check-inline">
