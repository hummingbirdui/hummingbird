...
Visually, these toggle buttons appear identical to checkbox toggle buttons. However, assistive technologies convey them differently: screen readers announce checkbox toggles as “checked”/“not checked” (as they remain fundamentally checkboxes despite their appearance), whereas these toggle buttons are announced as “button”/“button pressed.” The choice between these two approaches should be based on the specific type of toggle being created, and whether the toggle's function is best understood by users when announced as a checkbox or as an actual button.
