...
<Example class="flex justify-center" code={`<div class="card max-w-90 h-110 bg-[linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0.9)),url('https://plus.unsplash.com/premium_photo-1673002094195-f18084be89ce?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center">
    <div class="card-body mt-auto grow-0">
      <p class="mb-2 text-gray-300">Mar 20, 2025</p>
