...
- **Update:** Removed `--avatar-width` and `--avatar-height` variables and added `--avatar-size` variant that controls width and height
- **Update:** Added `--avatar-status-size` variable to control the size of the status indicator
- **Update:** Update versions of used dependencies in the project
